...
var $author$project$Main$BadOrder = {$: 'BadOrder'};
var $author$project$Main$Correct = {$: 'Correct'};
var $author$project$Main$InOrder = {$: 'InOrder'};
var $author$project$Main$Incorrect = {$: 'Incorrect'};
var $author$project$Main$NotInOrder = {$: 'NotInOrder'};
var $author$project$Main$NotInWord = {$: 'NotInWord'};
var $author$project$Main$NotUsed = {$: 'NotUsed'};
...
var $author$project$Main$getKeyBoardColor = F4(
	function (currentKey, currentIndex, arrayOfWords, wordToGuess) {
		...
		if (!_v0.a) {
			return $author$project$Main$NotUsed;
		} else {
			if (_v0.b) {
				if (_v0.c) {
					return $author$project$Main$InOrder;
				} else {
					return $author$project$Main$NotInOrder;
				}
			} else {
				return $author$project$Main$NotInWord;
			}
		}
	});
var $author$project$Main$getLetterState = F3(
	function (currentPosition, _char, wordToGuess) {
		...
		return A2($elm$core$List$member, currentPosition, indexes) ? $author$project$Main$Correct : (A2($elm$core$String$contains, charToString, wordToGuess) ? $author$project$Main$BadOrder : $author$project$Main$Incorrect);
	});
...
var $author$project$MainTest$suite = function () {
	var wordsProven = $elm$core$Array$fromList(
		_List_fromArray(
			['renmod', '', '', '', '', '']));
	var word = 'random';
	var indexOfWords = 1;
			...
			[
				...
				_List_fromArray(
					[
						...
						'Get correct on right position',
						function (_v0) {
							return A2(
								$elm_explorations$test$Expect$equal,
								$author$project$Main$Correct,
								A3(
									$author$project$Main$getLetterState,
									0,
									_Utils_chr('r'),
									word));
						}),
						A2(
						$elm_explorations$test$Test$test,
						'Get incorrect-position  on exist but wrong position',
						function (_v1) {
							return A2(
								$elm_explorations$test$Expect$equal,
								$author$project$Main$BadOrder,
								A3(
									$author$project$Main$getLetterState,
									4,
									_Utils_chr('r'),
						...
						A2(
						$elm_explorations$test$Test$test,
						'Get wrong when the letter is not in the word',
						function (_v2) {
							return A2(
								$elm_explorations$test$Expect$equal,
								$author$project$Main$Incorrect,
								A3(
									$author$project$Main$getLetterState,
									4,
									_Utils_chr('e'),
				...
				_List_fromArray(
					[
						A2(
						$elm_explorations$test$Test$test,
						'The key is written in the right order previously',
						function (_v3) {
							return A2(
								$elm_explorations$test$Expect$equal,
								$author$project$Main$InOrder,
								A4(
									$author$project$Main$getKeyBoardColor,
									_Utils_chr('r'),
									indexOfWords,
									wordsProven,
									word));
						...
						A2(
						$elm_explorations$test$Test$test,
						'The key is written but never in order previously',
						function (_v4) {
							return A2(
								$elm_explorations$test$Expect$equal,
								$author$project$Main$NotInOrder,
								A4(
									$author$project$Main$getKeyBoardColor,
									_Utils_chr('m'),
									indexOfWords,
						...
						A2(
						$elm_explorations$test$Test$test,
						'The key has proven and it is not in the word',
						function (_v5) {
							return A2(
								$elm_explorations$test$Expect$equal,
								$author$project$Main$NotInWord,
								A4(
									$author$project$Main$getKeyBoardColor,
									_Utils_chr('e'),
									indexOfWords,
						...
						A2(
						$elm_explorations$test$Test$test,
						'The key has not been proven yet',
						function (_v6) {
							return A2(
								$elm_explorations$test$Expect$equal,
								$author$project$Main$NotUsed,
								A4(
									$author$project$Main$getKeyBoardColor,
									_Utils_chr('q'),
									indexOfWords,
